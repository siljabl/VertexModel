...
python analysis/compute_correlations.py data/simulated/raw/nodivision_20250917_N30_L64_Lambda100_v050_taup100/ -o --dr=2
python analysis/compute_correlations.py data/simulated/raw/nodivision_20250917_N30_L64_Lambda100_v0100_taup100/ -o --dr=2
python analysis/compute_correlations.py data/simulated/raw/nodivision_20250917_N30_L64_Lambda100_v0150_taup100/ -o --dr=2
python analysis/compute_correlations.py data/simulated/raw/nodivision_20250917_N30_L64_Lambda100_v0200_taup100/ -o --dr=2
